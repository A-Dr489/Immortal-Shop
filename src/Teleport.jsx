  ...
  return (
    <>
      <nav className='daddy-Nav'>
        <h1 onClick={handleTPSecret} className='headers'>Immortal Shopping</h1>
        <img onClick={handleSecret} src={ez} width={55} style={{border: "2px solid black", borderRadius: "10px", boxShadow: "0px 3px 4px black"}}/>
        <div className='nav-btns-handle'>
          ...
          <button className='nav-cart' onClick={handleCart}>
            <div style={{display: "flex", gap: '5px', alignItems: "center"}}>
              ...
              {shop.length > 0? <span style={{color: "var(--secondary)", backgroundColor: "white", padding: "5px 10px", borderRadius: "100px"}}>{shop.length}</span> : ""}
